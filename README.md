...
2026-07-15 기준 오프라인 fallback 100례는 약 0.17초에 생성되었고 100/100 검증을 통과했습니다. 실제 Codex 병렬 호출 20례는 약 90초에 완료되었으며 20개 파일이 생성되었지만, Codex가 검증 안내문을 반환한 2례가 있어 최종 구조 검증은 18/20만 통과했습니다. 이 실패는 정상 환자 JSON으로 자동 대체하지 않고 실패로 기록해야 합니다.
